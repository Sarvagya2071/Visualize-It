...
import 'package:simulate/models/quiz_category.dart';
...
class QuizController extends GetxController {
  ...
  loadQuestions(QuizCategory category) async {
    ...
    http.Response res = await http.get(
      Uri.parse(
        "https://opentdb.com/api.php?amount=10&category=${category.id}&difficulty=${category.difficulity.toLowerCase()}&type=multiple",
      ),
    );
