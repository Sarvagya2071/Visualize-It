                            ...
                            if(url=="quizz")
                              {
                                SweetAlert.show(context,
                                                      title: "Ready To Give Quiz!",
                                                      subtitle: "Take a quiz and test your ability.",
                                                      confirmButtonText: "yesss",
                                                      style: SweetAlertStyle.success);
                              }
                            else{
                              SweetAlert.show(context,
                              title: "Great! You want to know more about "+widget.simulationName+".",
                              subtitle: "Well, you will be redirected to another-site",
                              ...
                              if (isConfirm){
                                    ...
                                    SweetAlert.show(context,style: SweetAlertStyle.error,title: "Could Not Launch");
